...
def build_multi_doc_cases() -> List[Dict]:
    return [
        ...
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_multi_judge", "doc_agreement_rate"],
            "metadata": {"difficulty": "hard", "type": "multi-doc"}
        },
        {
        ...
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_ai_eval_intro", "doc_release_gate"],
            "metadata": {"difficulty": "hard", "type": "multi-doc"}
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_async_runner", "doc_regression"],
            "metadata": {"difficulty": "hard", "type": "multi-doc"}
        },
        {
        ...
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_multi_judge", "doc_regression"],
            "metadata": {"difficulty": "hard", "type": "multi-doc"}
        },
        {
    ...
    return [
        {
            ...
            "ground_truth_doc_ids": ["doc_hit_rate"],
        ...
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_agreement_rate"],
            "metadata": {"difficulty": "hard", "type": "prompt-injection"}
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_release_gate"],
        ...
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_failure_analysis"],
            "metadata": {"difficulty": "hard", "type": "prompt-injection"}
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_async_runner"],
            "metadata": {"difficulty": "hard", "type": "goal-hijacking"}
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_five_whys"],
        ...
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_regression"],
            "metadata": {"difficulty": "hard", "type": "prompt-injection"}
        }
    ]
...
def build_hard_cases() -> List[Dict]:
    return [
        ...
        },
        {
            ...
            "ground_truth_doc_ids": ["doc_multi_judge"],
